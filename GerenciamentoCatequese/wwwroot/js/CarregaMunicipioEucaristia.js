document.addEventListener("DOMContentLoaded", function () {
    ...
    if (idCatequisandoEditarElem) {
        ...
        if (idCatequisandoEditar !== 0) {
            let ufBatismoElem = document.getElementById("ufEucaristia");

            if (ufBatismoElem && ufBatismoElem.value) {
                const ufElem = document.getElementById("ufEucaristia");
                ...
                let campos = ["dataEucaristia", "ufEucaristia", "municipioEucaristia", "paroquiaEucaristia"];
